const bot = {
    general: [{
        ...
        trigger:["fuck", "hell", "shit", "ass", "bastard", "bitch", "cunt", "bugger", "twat", "suck",], 
        response: ["Watch your language my dear", "Pardon, I do not speak to people with bad manners, I am a respected butler!"]
        }
    ],
    ...
    endState: [{
        ...
        response: [{
            text:["Coffee time, bye", "I need to leave now, cannot leave my lover waiting ofr me", "I am going out for a cigar!"]
        }]
    }],

    decideTellTrivia: [{
        trigger: [["yes", "yeah", "great", "sure", "of course", "like", "love", "alright", "roger", "positive", "ok",],["trivia"]],
        responses: [{
          text: ["Currywurst has its own dedicated museum, wait no more and visit the Deutsches Currywurst Museum!", "800 million Currywurst are eaten every year in Germany and about 70 million just in Berlin, imagine the pleasure! ", "Currywurst exists also as a flauvored energy drink.",],
          nextState: initial
        }],
    ...
    decideTellLoveStory: [{
        trigger: [["yes", "yeah", "great", "sure", "of course", "like", "love", "alright", "roger", "positive", "ok",],["story"]],
        responses: [{
          text: ["Since the day I met Hertha I cannot stop talking about her, one day we were eating a currywurst and it started to rain, I wanted to go home and leave the currywurst behind, but she said Curry On Manfred I am hungry, and we had the greatest currywurst of our life!", "Until this day Simon's Bude exists, and ouy love story has been passed to all further generations."],
          nextState: "endState"
        }],
        trigger: ["no", "nope", "nop", "never", "hardly", "nay", "negative"],
        responses: [{
